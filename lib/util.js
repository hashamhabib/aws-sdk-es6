...
import * as browserCreateHash from './browserCryptoLib';
...
var util = {
  ...
  crypto: {
    ...
    hash: function (algorithm, data, digest, callback) {
      var hash = browserCreateHash.default.createHash(algorithm);
      if (!digest) { digest = 'binary'; }
      if (digest === 'buffer') { digest = undefined; }
    ...
    createHash: function createHash(algorithm) {
      return browserCreateHash.default.createHash(algorithm);
    }
